...
<h1 style="font-family: Georgia, Serif;color:#A4A4A4">New Script Filtre All Domain List </h1>
...
$emails = $_POST['emails'];
$mails = array ("prodigy","snet","sbcglobal","flash","ameritech","bellsouth","nvbelllive","nvbell","att.net","comcast","earthlink.net","cox.net","gmail","bigpond","orange","hotmail","aol","yahoo","sympatico","mail.ru","gmx","msn","outlook","live","me","icloud","wanadoo","seznam","bbox.fr","sfr","free.fr","web","yandex");
